    ...
    <div>
      ...
      <form className="mb-4 flex gap-2">
        ...
        <input
          ...
          className="w-full min-w-0 flex-1 rounded-md border border-border px-3 py-2 text-sm text-foreground focus:border-slate-500 focus:outline-none focus:ring-1 focus:ring-slate-500 sm:w-72 sm:flex-none"
        />
        <button
          type="submit"
