...
export default async function PdvPage() {
  ...
  if (!canSell(user.role)) {
    return (
      <div className="rounded-xl border border-border bg-surface p-6 text-sm text-text-muted shadow-sm">
  ...
  if (!register) {
    return (
      <div>
        ...
        <div className="max-w-md rounded-xl border border-warning/25 bg-warning/10 p-6">
